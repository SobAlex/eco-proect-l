<div class="container row flex-nowrap justify-content-between contactHeaders">
    <div class="col-1 pt-1">
        <a href="{{ route('main.index') }}">
            <img src="/public/build/assets/logo-DygrE5AV.png" alt="logo" width="70">
    ...
    <div class="col-1 d-flex justify-content-end">
        <img src="/public/build/assets/icons8-whatsapp-48-DFh_Js_l.png" alt="whatsapp" width="45" height="45">
