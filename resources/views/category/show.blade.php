...
<div class="container">
    ...
    <div class="p-4 p-md-5 mb-4 rounded bg-category" style="background-image: url('/{{ $category->image }}')">
        <div class="col-lg-6 px-0 shadow-sm bg-body rounded">
            <h1 class="display-4 fst-italic p-3">{{ $category->title }}</h1>
            <p class="lead p-3">{{ $category->short_content }}</p>
        </div>
    </div>
    ...
    <div class="container px-4 py-5" id="featured-3">
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
            ...
            <div class="feature col">
                ...
                <h2 class="fs-2 text-body-emphasis">{{ $post->title }}</h2>
